...
vert_shader = createshader(joinpath(@__DIR__, "fog.vert"), GL_VERTEX_SHADER)
frag_shader = createshader(joinpath(@__DIR__, "fog.frag"), GL_FRAGMENT_SHADER)

# link program
shader_prog = createprogram(vert_shader, frag_shader)
time_loc = glGetUniformLocation(shader_prog, "time")
